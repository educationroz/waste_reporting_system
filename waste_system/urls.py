...
urlpatterns = [
    ...
    # DRF's URLPathVersioning reads the version from the URL kwargs;
    # the <version> capture is passed to the included URLs.
    path('api/<str:version>/', include('api_app.urls')),
